<div align="left" style="display: flex; align-items: center; margin-bottom: 2em;">
  <img src="me_in_bolo.JPG" alt="Me at a cafe in Bologna a while ago" 
       style="width: 170px; height: 170px; border-radius: 50%; margin-right: 15px; object-fit: cover; object-position: center;">
  <div>
    <strong>PhD Student</strong><br>
    UKRI Centre for Doctoral Training in Designing Responsible NLP, The University of Edinburgh<br>
    email: a.terranova@ed.ac.uk<br>
...
* **SMASH at SemEval-2026 Task 9: Detecting Multilingual Polarisation with Encoder Ensembles and Calibrated Decision Thresholds**<br>
  Z. Bokaei<sup>⋆</sup>, A. Terranova<sup>⋆</sup>, Y. Zheng<sup>⋆</sup>, T. Bidewell, B. Ross<br>
  *Accepted at SemEval-2026* (upcoming)

* **Evaluating Long-Term Memory for Long-Context Question Answering**<br>
  A. Terranova, B. Ross, A. Birch<br>
